...
releaseProcess := {
  Seq[ReleaseStep](
    ...
    releaseStepCommandAndRemaining("mongocamp-library/sonatypeBundleRelease"),
    releaseStepCommandAndRemaining("mongocamp-server/sonatypeBundleRelease"),
    releaseStepCommandAndRemaining("mongocamp-test-server/sonatypeBundleRelease"),
    releaseStepCommandAndRemaining("ci-docker"),
    releaseStepCommandAndRemaining("ci-deploy-docs"),
    setToMyNextVersion,
    gitAddAllTask,
    commitNextVersion,
    pushChanges,

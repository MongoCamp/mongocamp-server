...
object Server extends App with RestServer {
  ...
  override val serverEndpoints =
    informationRoutes ++ CreateRoutes.createEndpoints ++ ReadRoutes.readEndpoints ++ UpdateRoutes.updateEndpoints ++ DeleteRoutes.deleteEndpoints ++ IndexRoutes.indexEndpoints

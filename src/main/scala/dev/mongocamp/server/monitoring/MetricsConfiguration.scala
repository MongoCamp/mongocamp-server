...
object MetricsConfiguration {
  ...
  private lazy val systemMeterBinder: ArrayBuffer[MeterBinder] =
    ArrayBuffer(new DiskSpaceMetrics(new File("/")), new FileDescriptorMetrics(), new ProcessorMetrics(), new UptimeMetrics())

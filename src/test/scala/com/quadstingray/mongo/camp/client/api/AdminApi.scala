...
class AdminApi(baseUrl: String) extends CirceSchema {
  ...
  /** Add a new Role
    ...
    * @param role
    */
  def addRoles(apiKey: String, bearerToken: String)(role: Role) =
    basicRequest
  ...
  /** Delete Role
    ...
    *   RoleKey
    */
  def deleteRoles(apiKey: String, bearerToken: String)(roleName: String) =
    basicRequest
  ...
  /** Get Role
    ...
    *   UserRoleKey
    */
  def getRoles(apiKey: String, bearerToken: String)(roleName: String) =
    basicRequest

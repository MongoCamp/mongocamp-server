...
class AdminApi(baseUrl: String) {
  ...
  /** Add a new UserRole
    ...
    * @param role
    */
  def addUserRoles(apiKey: String, bearerToken: String)(role: Role) =
    basicRequest
  ...
  def deleteUserRoles(apiKey: String, bearerToken: String)(userRoleName: String) =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/admin/roles/$userRoleName")
      .contentType("application/json")
      .header("X-AUTH-APIKEY", apiKey)
      .auth
      .bearer(bearerToken)
  ...
  def getUserRoles(apiKey: String, bearerToken: String)(userRoleName: String) =
    basicRequest
      .method(Method.GET, uri"$baseUrl/admin/roles/$userRoleName")
      .contentType("application/json")
      .header("X-AUTH-APIKEY", apiKey)
      .auth
      .bearer(bearerToken)
  ...
  /** List all UserRolss or filtered
    ...
    */
  def listUserRoles(apiKey: String, bearerToken: String)(filter: Option[String] = None, rowsPerPage: Option[Long] = None, page: Option[Long] = None) =
    basicRequest
  ...
  /** Update UserRole
    ...
    */
  def updateUserRole(apiKey: String, bearerToken: String)(userRoleName: String, updateRoleRequest: UpdateRoleRequest) =
    basicRequest
      .method(Method.PATCH, uri"$baseUrl/admin/roles/$userRoleName")
      .contentType("application/json")
      .header("X-AUTH-APIKEY", apiKey)
      .auth
      .bearer(bearerToken)

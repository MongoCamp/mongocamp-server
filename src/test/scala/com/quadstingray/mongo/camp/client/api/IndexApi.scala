...
class IndexApi(baseUrl: String) extends CirceSchema {
  ...
  /** Create Index for Collection
    ...
    */
  def createIndex(apiKey: String, bearerToken: String)(collectionName: String, indexCreateRequest: IndexCreateRequest) =
    basicRequest
  ...
  def createIndexForField(
      apiKey: String,
      bearerToken: String
  )(collectionName: String, fieldName: String, indexOptionsRequest: IndexOptionsRequest, sortAscending: Option[Boolean] = None) =
    basicRequest
  ...
  /** Create Index by Field for Collection
    ...
    * @param indexOptionsRequest
    */
  def createTextIndexForField(apiKey: String, bearerToken: String)(collectionName: String, fieldName: String, indexOptionsRequest: IndexOptionsRequest) =
    basicRequest
  ...
  /** Delete Index by Name for Collection
    ...
    */
  def deleteIndex(apiKey: String, bearerToken: String)(collectionName: String, indexName: String) =
    basicRequest

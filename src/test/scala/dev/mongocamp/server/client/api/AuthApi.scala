...
import dev.mongocamp.server.client.model.{JsonValueBoolean, JsonValueString, Login, LoginResult, PasswordUpdateRequest, UserProfile}
...
class AuthApi(baseUrl: String) extends CirceSchema {
  ...
  /** Change Password of logged in User
    ...
    */
  def updatePassword(username: String, password: String, bearerToken: String, apiKey: String)(

...
import dev.mongocamp.server.client.model.{JsonSchema, JsonValueBoolean, MongoAggregateRequest, SchemaAnalysis}
...
class CollectionApi(baseUrl: String) extends CirceSchema {
  ...
  /** Aggregate in a given Collection
    ...
    */
  def aggregate(username: String, password: String, bearerToken: String, apiKey: String)(
  ...
  /** Delete all Document in Collection
    ...
    *   The name of your MongoDb Collection
    */
  def clearCollection(username: String, password: String, bearerToken: String, apiKey: String)(
      collectionName: String
  ) =
    basicRequest
  ...
  /** Delete a given Collection
    ...
    *   The name of your MongoDb Collection
    */
  def deleteCollection(username: String, password: String, bearerToken: String, apiKey: String)(
      collectionName: String
  ) =
    basicRequest
  ...
  /** List the Fields in a given collection
    ...
    */
  def getCollectionFields(username: String, password: String, bearerToken: String, apiKey: String)(
      collectionName: String,
  ...
  /** List of all Collections of the given database
    ...
    */
  def listCollectionsByDatabase(username: String, password: String, bearerToken: String, apiKey: String)(
      databaseName: String
  ) =
    basicRequest

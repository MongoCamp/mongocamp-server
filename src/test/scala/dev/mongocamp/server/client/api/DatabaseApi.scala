...
class DatabaseApi(baseUrl: String) extends CirceSchema {
  ...
  /** Delete given Database
    ...
    */
  def deleteDatabase(username: String, password: String, bearerToken: String, apiKey: String)(
      databaseName: String
  ) =
    basicRequest
  ...
  /** All Information about given Database
    ...
    *   Name of your Database
    */
  def getDatabaseInfo(username: String, password: String, bearerToken: String, apiKey: String)(
      databaseName: String
  ) =
    basicRequest

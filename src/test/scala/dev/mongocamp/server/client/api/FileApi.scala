...
import dev.mongocamp.server.client.model.{DeleteResponse, FileInformation, InsertResponse, MongoFindRequest, UpdateFileInformationRequest, UpdateResponse}
...
class FileApi(baseUrl: String) extends CirceSchema {
  ...
  /** Delete one File from given Bucket
    ...
    *   fileId to delete
    */
  def deleteFile(username: String, password: String, bearerToken: String, apiKey: String)(
      bucketName: String,
      fileId: String
  ) =
    basicRequest
  ...
  /** Alternative to GET Route for more complex queries and URL max. Length
    ...
    */
  def findFiles(username: String, password: String, bearerToken: String, apiKey: String)(
      bucketName: String,
  ...
  /** Get one FileInformation from given Bucket
    ...
    *   fileId to read
    */
  def getFileInformation(username: String, password: String, bearerToken: String, apiKey: String)(
      bucketName: String,
      fileId: String
  ) =
    basicRequest

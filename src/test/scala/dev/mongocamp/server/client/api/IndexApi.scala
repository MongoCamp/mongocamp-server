...
import dev.mongocamp.server.client.model.{IndexCreateRequest, IndexCreateResponse, IndexDropResponse, IndexOptionsRequest, MongoIndex}
...
class IndexApi(baseUrl: String) extends CirceSchema {
  ...
  /** Create expiring Index by Field for given Collection
    ...
    *   Name for your index
    */
  def createExpiringIndex(username: String, password: String, bearerToken: String, apiKey: String)(
  ...
  /** Create Index for given Collection
    ...
    */
  def createIndex(username: String, password: String, bearerToken: String, apiKey: String)(
      collectionName: String,
  ...
  /** Create Index by Field for given Collection
    ...
    */
  def createIndexForField(username: String, password: String, bearerToken: String, apiKey: String)(
      collectionName: String,
      fieldName: String,
      sortAscending: Option[Boolean] = None,
  ...
  /** Create Unique Index by Field for given Collection
    ...
    *   Name for your index
    */
  def createUniqueIndex(username: String, password: String, bearerToken: String, apiKey: String)(
      collectionName: String,
      fieldName: String,
      sortAscending: Option[Boolean] = None,
      name: Option[String] = None
  ...
  /** Delete Index by Name for given Collection
    ...
    */
  def deleteIndex(username: String, password: String, bearerToken: String, apiKey: String)(
      collectionName: String,
      indexName: String
  ) =
    basicRequest
  ...
  /** Index by Name for given Collection
    ...
    *   The name of your Index
    */
  def index(username: String, password: String, bearerToken: String, apiKey: String)(
      collectionName: String,
      indexName: String
  ) =
    basicRequest
  ...
  /** List all Indices for given Collection
    ...
    *   The name of your MongoDb Collection
    */
  def listIndices(username: String, password: String, bearerToken: String, apiKey: String)(
      collectionName: String
  ) =
    basicRequest

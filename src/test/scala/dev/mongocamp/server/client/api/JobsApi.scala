...
class JobsApi(baseUrl: String) extends CirceSchema {
  ...
  /** Delete Job and reload all Job Information
    ...
    *   Name of the Job
    */
  def deleteJob(username: String, password: String, bearerToken: String, apiKey: String)(
      jobGroup: String,
      jobName: String
  ) =
    basicRequest
  ...
  /** Execute scheduled Job manually
    ...
    *   Name of the Job
    */
  def executeJob(username: String, password: String, bearerToken: String, apiKey: String)(
      jobGroup: String,
      jobName: String
  ) =
    basicRequest
  ...
  /** Register an Job and return the JobInformation with next schedule information
    ...
    * @param jobConfig
    */
  def registerJob(username: String, password: String, bearerToken: String, apiKey: String)(
      jobConfig: JobConfig
  ) =
    basicRequest
  ...
  /** Add Job and get JobInformation back
    ...
    * @param jobConfig
    */
  def updateJob(username: String, password: String, bearerToken: String, apiKey: String)(
      jobGroup: String,
      jobName: String,
      jobConfig: JobConfig
  ) =

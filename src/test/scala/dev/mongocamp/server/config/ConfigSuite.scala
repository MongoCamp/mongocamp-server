...
import dev.mongocamp.server.config.ConfigManager.{getConfig, registerNonPersistentConfig}
...
class ConfigSuite extends munit.FunSuite with LazyLogging {
  ...
  test("convert config with strings to database config") {
    val dbSimpleStringConfig = ConfigManager.convertToDbConfiguration("simple.string", "String", Some("super"))
    ...
    val dbSimpleStringConfig1 = ConfigManager.convertToDbConfiguration("simple.string", "String")
    ...
    val dbListStringConfig = ConfigManager.convertToDbConfiguration("list.string", "List[String]", Some(List("List", "super")))
    ...
    val dbListStringConfig2 = ConfigManager.convertToDbConfiguration("list.string", "List[String]")
  ...
  test("convert config with boolean to database config") {
    val dbSimpleBooleanConfig = ConfigManager.convertToDbConfiguration("simple.boolean", "Boolean", Some(true))
    ...
    val dbSimpleBooleanConfig1 = ConfigManager.convertToDbConfiguration("simple.boolean", "Boolean")
    ...
    val dbListBooleanConfig = ConfigManager.convertToDbConfiguration("list.boolean", "List[Boolean]", Some(List(true, false)))
    ...
    val dbListBooleanConfig2 = ConfigManager.convertToDbConfiguration("list.boolean", "List[Boolean]")
  ...
  test("convert config with double to database config") {
    val dbSimpleDoubleConfig = ConfigManager.convertToDbConfiguration("simple.double", "Double", Some(1.32))
    ...
    val dbSimpleDoubleConfig1 = ConfigManager.convertToDbConfiguration("simple.double", "Double")
    ...
    val dbListDoubleConfig = ConfigManager.convertToDbConfiguration("list.double", "List[Double]", Some(List(1.0, 3.0)))
    ...
    val dbListDoubleConfig2 = ConfigManager.convertToDbConfiguration("list.double", "List[Double]")
  ...
  test("convert config with long to database config") {
    val dbSimpleLongConfig = ConfigManager.convertToDbConfiguration("simple.long", "Long", Some(21L))
    ...
    val dbSimpleLongConfig1 = ConfigManager.convertToDbConfiguration("simple.long", "Long")
    ...
    val dbListLongConfig = ConfigManager.convertToDbConfiguration("list.long", "List[Long]", Some(List(4711L, 4712L)))
    ...
    val dbListLongConfig2 = ConfigManager.convertToDbConfiguration("list.long", "List[Long]")
  ...
  test("convert config with int to database config") {
    val dbSimpleIntConfig = ConfigManager.convertToDbConfiguration("simple.int", "Int", Some(21))
    ...
    val dbSimpleIntConfig1 = ConfigManager.convertToDbConfiguration("simple.int", "Int")
    ...
    val dbListIntConfig = ConfigManager.convertToDbConfiguration("list.int", "List[Int]", Some(List(4711, 4712)))
    ...
    val dbListIntConfig2 = ConfigManager.convertToDbConfiguration("list.int", "List[Int]")
  ...
  test("convert config with duration to database config") {
    val dbSimpleDurationConfig = ConfigManager.convertToDbConfiguration("simple.duration", "Duration", Some(Duration("1s")))
    ...
    val dbSimpleDurationConfig1 = ConfigManager.convertToDbConfiguration("simple.duration", "Duration")
    ...
    val dbListDurationConfig = ConfigManager.convertToDbConfiguration("list.duration", "List[Duration]", Some(List(Duration("2m"), Duration("3h"))))
    ...
    val dbListDurationConfig2 = ConfigManager.convertToDbConfiguration("list.duration", "List[Duration]")
